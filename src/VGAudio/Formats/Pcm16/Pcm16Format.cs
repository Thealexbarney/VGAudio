...
namespace VGAudio.Formats.Pcm16
{
    ...
    /// </summary>
    public class Pcm16Format : AudioFormatBase<Pcm16Format, Pcm16Format.Builder, CodecParameters>
    {
        ...
        public class Builder : AudioFormatBaseBuilder<Pcm16Format, Builder, CodecParameters>
        {
