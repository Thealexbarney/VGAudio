...
{
    public class DspToolCafe64Debug : IDspTool
    {
        private const string DllName = "dsptoolcafe64D.dll";
        ...
        public DspToolCafe64Debug(string path)
        {
        ...
        public void GetDelegates()
        {
            ...
            IntPtr pDspCorrelateCoefs = pDll + 0x53c0;
            ...
            IntPtr pDspEncodeFrame = pDll + 0x2490;
