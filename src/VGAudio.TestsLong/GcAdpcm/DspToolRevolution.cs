...
{
    public class DspToolRevolution : IDspTool
    {
        private const string DllName = "dsptoolrevolution.dll";
        ...
        public DspToolRevolution(string path)
        {
        ...
        public void GetDelegates()
        {
            ...
            IntPtr pDspCorrelateCoefs = pDll + 0x3ce0;
            ...
            IntPtr pDspEncodeFrame = pDll + 0x19d0;
