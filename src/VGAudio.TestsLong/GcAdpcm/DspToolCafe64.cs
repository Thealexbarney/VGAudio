...
{
    public class DspToolCafe64 : IDspTool
    {
        private const string DllName = "dsptoolcafe64.dll";
        ...
        public DspToolCafe64(string path)
        {
        ...
        public void GetDelegates()
        {
            ...
            IntPtr pDspCorrelateCoefs = pDll + 0x3900;
            ...
            IntPtr pDspEncodeFrame = pDll + 0x1b90;
