...
namespace VGAudio.Tests.Formats.Atrac9
{
    ...
    {
        public static byte[][] HuffmanScaleFactorsABits { get; } =
        {
            null,
        ...
        public static short[][] HuffmanScaleFactorsACodes { get; } =
        {
            null,
        ...
        public static byte[][] HuffmanScaleFactorsBBits { get; } =
        {
            null, null,
            ScaleFactorsB2Bits, ScaleFactorsB3Bits, ScaleFactorsB4Bits, ScaleFactorsB5Bits
        };

        public static short[][] HuffmanScaleFactorsBCodes { get; } =
        {
            null, null,
            ScaleFactorsB2Codes, ScaleFactorsB3Codes, ScaleFactorsB4Codes, ScaleFactorsB5Codes
        };

        public static byte[] HuffmanScaleFactorsGroupSizes { get; } = { 0, 0, 0, 0, 0, 0, 0 };

        public static byte[][][] HuffmanSpectrumABits { get; } =
        {
            null,
            null,
        ...
        public static short[][][] HuffmanSpectrumACodes { get; } =
        {
            null,
            null,
        ...
        public static byte[][] HuffmanSpectrumAGroupSizes { get; } =
        {
            new byte[] {0, 0, 0, 0},
            new byte[] {0, 0, 0, 0},
            new byte[] {1, 2, 2, 2},
        ...
        public static byte[][][] HuffmanSpectrumBBits { get; } =
        {
            null,
            null,
        ...
        public static short[][][] HuffmanSpectrumBCodes { get; } =
        {
            null,
            null,
        ...
        public static byte[][] HuffmanSpectrumBGroupSizes { get; } =
        {
            new byte[] {0, 0, 0, 0},
            new byte[] {0, 0, 0, 0},
            new byte[] {0, 2, 2, 2},
       ...
       public static byte[][] SfWeights { get; } =
        {
            new byte[] {
